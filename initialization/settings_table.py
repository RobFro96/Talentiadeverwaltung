...
SETTINGS = {
    ...
    "attendees_header": {"cell": "B7", "type": ValueType.NUMBER},
    "attendees_columns": {"cell": "B8", "type": ValueType.COLUMN_RANGE},
    "attendees_required": {"cell": "B9", "type": ValueType.STRING_LIST},
    "clubs_template": {"cell": "B12", "type": ValueType.STRING},
    "clubs_output": {"cell": "B13", "type": ValueType.STRING},
    "clubs_header": {"cell": "B14", "type": ValueType.NUMBER},
    "clubs_columns": {"cell": "B15", "type": ValueType.COLUMN_RANGE},
    "clubs_date_columns": {"cell": "B16", "type": ValueType.STRING_LIST},
    "clubs_cell_clubname": {"cell": "B17", "type": ValueType.CELL},
    "age_classifier": {"cell": "B20", "type": ValueType.STRING},
    "group_sort_before": {"cell": "B21", "type": ValueType.STRING_LIST},
    "group_sort_after": {"cell": "B22", "type": ValueType.STRING_LIST},
    "groups_template": {"cell": "B25", "type": ValueType.STRING},
    "groups_output": {"cell": "B26", "type": ValueType.STRING},
    "groups_header": {"cell": "B27", "type": ValueType.NUMBER},
    "groups_columns": {"cell": "B28", "type": ValueType.COLUMN_RANGE},
    "groups_cell_groupname": {"cell": "B29", "type": ValueType.CELL},
    "stations_template": {"cell": "B32", "type": ValueType.STRING},
    "stations_output": {"cell": "B33", "type": ValueType.STRING},
    "stations_header": {"cell": "B34", "type": ValueType.NUMBER},
    "stations_columns": {"cell": "B35", "type": ValueType.COLUMN_RANGE},
    "stations_cell_groupname": {"cell": "B36", "type": ValueType.STRING},
    "values_template": {"cell": "B39", "type": ValueType.STRING},
    "values_output": {"cell": "B40", "type": ValueType.STRING},
    "values_header": {"cell": "B41", "type": ValueType.NUMBER},
    "values_columns": {"cell": "B42", "type": ValueType.COLUMN_RANGE},
    "values_cell_groupname": {"cell": "B43", "type": ValueType.STRING},
    "values_input_file": {"cell": "B46", "type": ValueType.STRING},
    "values_input_header": {"cell": "B47", "type": ValueType.NUMBER},
    "values_input_columns": {"cell": "B48", "type": ValueType.COLUMN_RANGE},
    "values_input_required": {"cell": "B49", "type": ValueType.STRING_LIST},
    "scoring_template": {"cell": "B52", "type": ValueType.STRING},
    "scoring_output": {"cell": "B53", "type": ValueType.STRING},
    "scoring_header": {"cell": "B54", "type": ValueType.NUMBER},
    "scoring_columns": {"cell": "B55", "type": ValueType.COLUMN_RANGE}
}
